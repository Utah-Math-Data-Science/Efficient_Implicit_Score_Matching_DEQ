...
def parse_args_and_config():
    ...
    parser.add_argument(
        "--config", default="cifar10_ssm.yml", type=str, help="Path to the config file"
    )
    ...
    parser.add_argument(
        "--doc",
        type=str,
        default='ncsn_res_shallow_test01_resample',
    ...
    kwargs = {
                ...
                'mode': 'disabled',
                # 'name': 'ncsn_atten_deq_03', 
                'name': 'ncsn_refined_deq_11', 
                # 'name': 'cifer10_resnet_shallow', 
                # 'name': 'ncsn_resnet18_01',
                'config': args,
...
def main():
    ...
    try:
        runner = eval(config_dict["runner_name"])(args, config)
        if args.test:
            runner.test()
        elif args.sample:
            runner.sample()
